                                               ...
                                               bool allowMultipleLobes) const 
{
    ...
    si->bsdf->Add(
        ARENA_ALLOC(arena, MicrofacetReflection)(1.f, distrib, frMf));
}
...
pbrt::MetalMaterial* CreateMetalMaterial(const TextureParams& mp) 
{
    ...
    std::shared_ptr<Texture<Float>> roughness =
        mp.GetFloatTexture("roughness", 0.01f);
    ...
    return new pbrt::MetalMaterial(eta, k, roughness, uRoughness, vRoughness,
